...
> = {
  createAccount?: Resolver<
    ...
    ParentType,
    ContextType,
    RequireFields<MutationCreateAccountArgs, "email" | "firstName" | "password">
  >;
...
> = {
  seeProfile?: Resolver<
    ...
    ParentType,
    ContextType,
    Partial<QuerySeeProfileArgs>
  >;
};

export type SeeProfileResultResolvers<
  ContextType = any,
  ParentType extends ResolversParentTypes["SeeProfileResult"] = ResolversParentTypes["SeeProfileResult"]
> = {
  error?: Resolver<Maybe<ResolversTypes["String"]>, ParentType, ContextType>;
  ok?: Resolver<Maybe<ResolversTypes["Boolean"]>, ParentType, ContextType>;
  __isTypeOf?: IsTypeOfResolverFn<ParentType, ContextType>;
